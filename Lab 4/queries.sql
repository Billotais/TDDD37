...
CREATE TABLE Route # Route between 2 airports for a given year
    (rid INT NOT NULL AUTO_INCREMENT,
     rdeparture_airport VARCHAR(3),
     rarrival_airport VARCHAR(3),
     rprice DOUBLE,
     ryear INT,
...
BEGIN
	...
	ELSE 
		...
		ELSE
			...
			INSERT INTO Reservation VALUES (reservation_number, flight_number);
	...
	ELSE 
		...
		ELSE
            ...
            ELSE
				...
				INSERT INTO Booking VALUES (reservation_nr, (nb_passengers * calculatePrice(flight)), contact, credit_card_number);
