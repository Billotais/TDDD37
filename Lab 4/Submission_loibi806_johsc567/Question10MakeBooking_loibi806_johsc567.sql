...
SELECT SLEEP(5);
#LOCK TABLES Reservation WRITE,Contact WRITE,Seat WRITE, Ticket WRITE, 
#CreditCard WRITE, Booking WRITE, Year READ, Route READ, WeekDay READ, Flight READ, WeeklyFlight READ;
